  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        setErrorMsg(
          err instanceof Error ? err.message : 'Unable to load content right now.'
        );
      } finally {
        setLoading(false);
      }
      ...
      <header className="flex items-end justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">
            Scroll through recent performances and save artists for your next event.
          </p>
        </div>
      </header>
      ...
      <section className="space-y-4">
        ...
        {!loading && !errorMsg && posts.length === 0 && (
          <p className="text-sm text-slate-500">
            No content yet. Once musicians start posting, you&apos;ll see their
            latest performances here.
          </p>
        )}
        ...
        {!loading &&
          ...
          posts.map((post) => (
            ...
            >
              <div className="p-4">
                {/* Replace with real musician info later */}
                <div className="mb-3 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500">
                      Tap through to view their full profile
                    </p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between px-4 py-3 text-xs text-slate-500">
                ...
                <span>View full details on their profile</span>
              </div>
            </article>
          ))}
      </section>
