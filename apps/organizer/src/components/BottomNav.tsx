...
export default function BottomNav() {
  ...
  const tabs: Tab[] = [
    ...
    { href: '/gigs/create',label: 'Create', svg: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M12 5v14M5 12h14" /></svg> },
    { href: '/gigs',       label: 'Gigs',   svg: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M3 6h18M3 12h18M3 18h18" /></svg> },
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 z-40">
      <div className="mx-auto max-w-3xl px-3 pb-[env(safe-area-inset-bottom)]">
        <div className="mt-1 rounded-t-2xl border border-line border-b-0 bg-surface/95 backdrop-blur grid grid-cols-5 pt-2 pb-2 shadow-[0_-8px_24px_rgba(28,26,23,0.06)]">
          {tabs.map((t) => (
