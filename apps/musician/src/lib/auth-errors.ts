// App-local copy of the friendly auth-error mapper + password strength check.
// Kept in-app (rather than @arteve/shared) so Next.js picks up changes
// without a workspace-export reload.
