...
// We use a stand-alone, anon-key Supabase client here because this is server
// code (no cookies / no auth context). It's exactly the same read-only access
// any unauthenticated visitor would get; RLS still applies.
