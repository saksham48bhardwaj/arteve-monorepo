      ...
      <div className="mx-auto max-w-3xl h-14 px-4 flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-1">
          ...
          <div className="relative">
            <button
              onClick={() => setOpen((v) => !v)}
              className="inline-flex h-9 w-9 items-center justify-center rounded-full text-ink-muted hover:bg-surface-sunken hover:text-ink transition text-xl leading-none"
            ...
            {open && (
              <div className="absolute right-0 mt-2 w-44 rounded-xl border border-line bg-surface shadow-lg p-2">
